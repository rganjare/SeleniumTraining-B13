...
public class RegisterUserForTheSeleniumTraining4 extends TestBase {
	...
	public static void registerUserForTheSeleniumTraining4(Hashtable<String, String> htData) throws InterruptedException { // Test Step and Verification Points 	
